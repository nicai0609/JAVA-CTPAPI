...
public class CThostFtdcQryCurrDRIdentityField {
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        thostmduserapiJNI.delete_CThostFtdcQryCurrDRIdentityField(swigCPtr);
      }
      swigCPtr = 0;
    }
  }
  ...
  public void setDRIdentityID(int value) {
    thostmduserapiJNI.CThostFtdcQryCurrDRIdentityField_DRIdentityID_set(swigCPtr, this, value);
  }

  public int getDRIdentityID() {
    return thostmduserapiJNI.CThostFtdcQryCurrDRIdentityField_DRIdentityID_get(swigCPtr, this);
  }

  public CThostFtdcQryCurrDRIdentityField() {
    this(thostmduserapiJNI.new_CThostFtdcQryCurrDRIdentityField(), true);
  }
