...
public class CThostFtdcTraderApi {
  ...
  public int ReqUserLogin2(CThostFtdcReqUserLoginField pReqUserLogin, int nRequestID) {
    return thosttradeapiJNI.CThostFtdcTraderApi_ReqUserLogin2(swigCPtr, this, CThostFtdcReqUserLoginField.getCPtr(pReqUserLogin), pReqUserLogin, nRequestID);
  }

  public int ReqUserPasswordUpdate2(CThostFtdcUserPasswordUpdateField pUserPasswordUpdate, int nRequestID) {
    return thosttradeapiJNI.CThostFtdcTraderApi_ReqUserPasswordUpdate2(swigCPtr, this, CThostFtdcUserPasswordUpdateField.getCPtr(pUserPasswordUpdate), pUserPasswordUpdate, nRequestID);
  }
